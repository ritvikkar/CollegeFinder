...
def get_all_colleges():
    '''
    returns a list of dictionaries containg colleges, ids, summary information, and urls
    :return: 
    '''
...
def get_college_by_name(college_name):
    '''
    returns a list of dictionaries containing names, ids, location, and summary information for colleges whose names 
...
def get_city_colleges(city_name):
    '''
    returns a list of dictionaries containing names, ids, zip codes, and summary info for colleges in a specified city
    :param search_text: 
    :return: 
    '''
    query = '''SELECT  id, state, name, city, zipcode, insturl, alias, in_state_tuition, out_state_tuition, adm_rate, 
...
def get_state_colleges(state):
    '''
    returns a list of dictionaries of college names, ids, cities, and summary information in the specified state
    :param state: 
    :return: 
    '''
    query = '''SELECT id, state, name, city, zipcode, insturl, alias, in_state_tuition, out_state_tuition, adm_rate, 
